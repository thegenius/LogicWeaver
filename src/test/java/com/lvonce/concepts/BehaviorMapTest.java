...
//        assertEquals(BehaviorResult.TRUE, action3.apply(null, null));
...
//        assertEquals(BehaviorResult.FALSE, action7.apply(null, null));
...
//        assertEquals(false, func instanceof BehaviorResult);
//        assertEquals(BehaviorResult.DISCARD, func.apply(null, null));
...
//        assertEquals(BehaviorResult.DISCARD, action19.apply(null, null));
